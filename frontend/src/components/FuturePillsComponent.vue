<template>
  <section class="bg-white rounded-3xl py-12 sm:py-20 px-6 text-center overflow-visible">
    <div
      class="max-w-7xl mx-auto pt-8 sm:pt-16 pb-20 flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
      ...
      <div class="w-full lg:w-1/2 flex justify-center">
        <img
          src="../assets/png/watering_can.avif"
          alt="Enrichment graphic"
